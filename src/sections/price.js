...
<div class="price__wrapper relative max-w-screen-2xl m-auto">
  ...
  >
    <img
      src="/src/img/images/principles-image-3-big.jpg"
      alt="contact image"
  ...
  >
    ...
    >
      ...
      <form class="price__form flex flex-col gap-y-3 md:gap-y-5">
        <div
          class="price__form-inputs flex flex-col gap-y-3 sm:flex-row sm:gap-x-5"
        >
          <input
            type="text"
            placeholder="имя"
            class="price__form-name flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase"
          />
          <input
            type="text"
            placeholder="телефон"
            class="price__form-phone flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase"
          />
        </div>
        <div
          class="price__bottom flex flex-col gap-y-3 sm:flex-row sm:justify-between sm:gap-x-5"
        >
          <div class="price__form-check flex items-center gap-x-3">
            <input
              ...
              type="checkbox"
              value=""
              class="relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light"
            />
            <label
              for="primary-checkbox"
              class="text-light-grey text-[10px] 2xl:text-[14px] leading-[140%] tracking-[0.3px] 2xl:tracking-[0.42px] sm:max-w-[330px] 2xl:max-w-[450px]"
              >Даю своё согласие на обработку своей персональной информации
              на условиях, определенных Политикой в отношении обработки
              персональных данных.
            </label>
            <img
              src="/src/img/icons/checked-icon.svg"
              alt="check arrow"
              class="absolute w-5 h-5 2xl:w-7 2xl:h-7 hidden peer-checked:block pointer-events-none"
            />
          </div>
          <button
            class="price__form-button w-full px-4 2xl:px-10 py-[15px] 2xl:py-[22px] text-light text-[14px] 2xl:text-[16px] tracking-[2.1px] 2xl:tracking-[2.4px] uppercase bg-primary sm:px-6 sm:w-fit"
          >
            Отправить
          </button>
        </div>
      ...
      <div
        class="price__phone flex flex-col gap-y-[4px] md:flex-row md:items-center md:justify-between md:gap-x-5"
      >
        <p
          class="text-[14px] 2xl:text-[16px] leading-[160%] tracking-[0.4px] md:flex-1"
        >
          Если хотите получить ответ сразу позвоните нам по телефону:
        </p>
        <p
          class="text-[24px] leading-[125%] tracking-[0.5px] md:flex-1 2xl:text-[36px] 2xl:tracking-[0.72px]"
        >
          +7 495 145-25-98
        </p>
      </div>
      ...
      >
        <img
          src="/src/img/icons/whatsapp-logo.svg"
          alt="whatsapp logo"
          class="w-[20px] h-[20px]"
        />
