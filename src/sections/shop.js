...
<div
  class="shop__wrapper relative flex flex-col gap-y-5 xl:gap-y-10 max-w-screen-2xl m-auto"
>
  <div
    class="shop__title flex flex-col gap-y-3 px-5 md:px-10 xl:px-20 2xl:px-[120px] max-w-[714px] 2xl:max-w-[1150px] items-start text-left"
  >
    <p
    ...
    >
      ...
      <span
        ...
        >Готовые барельефы <br> на продажу</span
      >
    </p>
  </div>

  <div
    class="shop__box flex flex-col gap-y-5 pl-5 md:pl-10 xl:pl-20 2xl:pl-[120px] 2xl:pr-0 max-w-screen-2xl"
  >
    <div class="shop__slider">
      <div
        class="shop__slider-wrapper flex flex-col gap-y-5 overflow-hidden"
      >
        <div class="shop__slider-slides flex gap-x-5 md:gap-x-10">
          <div class="shop__slide flex flex-col gap-y-5 2xl:gap-y-8">
            <div
              class="shop__slide-image w-[300px] h-[400px] xl:w-[374px] xl:h-[480px] 2xl:w-[528px] 2xl:h-[720px] overflow-hidden"
            >
              <img
                src="/src/img/images/shop/shop-image-2xl-1.jpg"
                alt="project 1"
                class=""
              />
            </div>
            <div
              class="shop__slide-info flex flex-col gap-y-3 2xl:gap-y-5"
            >
              <div
              ...
              <div
                class="shop__slide-data flex justify-start items-center gap-x-4"
              >
          ...
          <div class="shop__slide flex flex-col gap-y-5 2xl:gap-y-8">
            ...
            >
              <img
                src="/src/img/images/shop/shop-image-2xl-2.jpg"
                alt="project 1"
                class=""
              />
            </div>
          ...
          <div class="shop__slide flex flex-col gap-y-5 2xl:gap-y-8">
            ...
            >
              <img
                src="/src/img/images/shop/shop-image-2xl-3.jpg"
                alt="project 1"
                class=""
              />
            </div>
  ...
  <div
    class="shop__slider-bottom flex flex-col lg:flex-row gap-y-5 lg:justify-between lg:items-center lg:order-2 mx-5 md:mx-10 xl:mx-20 2xl:mx-[120px] max-w-screen-2xl"
  >
    <div
      class="shop__slide-buttons flex justify-center gap-x-5 lg:gap-x-10 lg:order-2"
    >
      <button
    ...
    <button
      class="shop__button flex justify-center items-center px-6 py-[18px] 2xl:py-[18px] border border-primary lg:order-1"
    >
      <span
