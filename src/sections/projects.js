      ...
      >
        <div class='projects__slider-slides flex gap-x-5 md:gap-x-10'>
          <div class='projects__slide flex flex-col gap-y-5 2xl:gap-y-8'>
            ...
            >
              <img
                src='/img/images/projects-slider/slide-1-2xl.jpg'
                alt='project 1'
                class=''
              />
            </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                  <img
                    src='/img/icons/quotes-cloud-logo.svg'
                    alt='quotes cloud'
                    class='w-[28px] h-[25px]'
                  />
                </div>
          ...
          <div class='projects__slide flex flex-col gap-y-5 2xl:gap-y-8'>
            ...
            >
              <img
                src='/img/images/projects-slider/slide-2-2xl.jpg'
                alt='project 1'
                class=''
              />
            </div>
          ...
          <div class='projects__slide flex flex-col gap-y-5 2xl:gap-y-8'>
            ...
            >
              <img
                src='/img/images/projects-slider/slide-3-2xl.jpg'
                alt='project 1'
                class=''
              />
            </div>
