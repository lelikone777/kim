    ...
    <div class='contact__info flex flex-col gap-y-5 pt-2 md:gap-y-10 2xl:gap-y-16 xl:flex-1'>
      ...
      <form class='contact__form flex flex-col gap-y-3 md:gap-y-5'>
        <div class='contact__form-inputs flex flex-col gap-y-3 sm:flex-row sm:gap-x-5'>
          <input type='text' placeholder='имя' class='contact__form-name flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase'>
          <input type='text' placeholder='телефон' class='contact__form-phone flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase'>
        </div>
        <div class='contact__bottom flex flex-col gap-y-3 sm:flex-row sm:justify-between sm:gap-x-5'>
          <div class='contact__form-check flex items-center gap-x-3'>
            ...
            <img src='/src/img/icons/checked-icon.svg' alt='check arrow' class='absolute w-5 h-5 2xl:w-7 2xl:h-7 hidden peer-checked:block pointer-events-none'>
          </div>
          <button class='contact__form-button w-full px-4 2xl:px-10 py-[15px] 2xl:py-[22px] text-light text-[14px] 2xl:text-[16px] tracking-[2.1px] 2xl:tracking-[2.4px] uppercase bg-primary sm:px-6 sm:w-fit'>
            Отправить
          </button>
        </div>
      </form>
