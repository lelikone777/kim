    ...
    <div class='catalog__buttons flex flex-col gap-y-5 sm:flex-row sm:justify-between'>
      ...
      <div class='catalog__magazine pl-4'>
        <div class='catalog__magazine-wrap flex  w-full items-center bg-primary text-light fill-light hover:hover-bg'>
          ...
          <button class='catalog__magazine-right flex flex-col gap-y-[2px] py-3 pr-8'>
      ...
      <button class='catalog__filter-button flex-center border border-primary px-6 py-[15px] w-full gap-x-2 sm:w-fit xl:hidden hover:hover-border hover:hover-text'>
        ...
        <span class='text-button-primary text-primary !font-bold hover:hover-text'>Фильтры</span>
      </button>
  ...
  <div class='catalog__filter flex gap-x-[42px]'>
      ...
      <div class='catalog__form-wrap flex flex-col gap-y-[28px]'>
        ...
        <div class='catalog__form-price'>
          ...
          <div class='flex justify-between items-center gap-x-2'>
            <input type='text' placeholder='мин' class='flex max-h-[48px] px-4 py-[15px] xl:px-4 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase hover:hover-input'>           
            <div class='h-[1px] w-6 bg-light-grey'></div>          
            <input type='text' placeholder='макс' class='max-h-[48px] flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase hover:hover-input'>
          </div>
        </div>
        ...
        <div class='catalog__form-size'>
          ...
          <ul>
            <li class='contact__form-check flex items-center gap-x-3 border-t border-b py-2'>
              <input id='sizes-small' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:hover-bg'>
            ...
            <li class='contact__form-check flex items-center gap-x-3 border-t border-b py-2'>
              <input id='sizes-medium' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:hover-bg'>
            ...
            <li class='contact__form-check flex items-center gap-x-3 border-t border-b py-2'>
              <input id='sizes-large' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:hover-bg'>
        ...
        <div class='catalog__form-shape'>
          ...
          <ul>
            <li class='contact__form-check flex items-center gap-x-3 border-t border-b py-2'>
              <input id='shape-small' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:hover-bg'>
              <label for='shape-small' class='text-14-300 !leading-[125%] '>Квадрат <span class='text-light-grey'>(7)</span>
              </label>
              <img src='/img/icons/checked-icon.svg' alt='check arrow' class='absolute w-5 h-5 2xl:w-7 2xl:h-7 hidden peer-checked:block pointer-events-none'>
            </li>
            <li class='contact__form-check flex items-center gap-x-3 border-t border-b py-2'>
              <input id='shape-medium' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:hover-bg'>
              <label for='shape-medium' class='text-14-300 !leading-[125%] '>Прямоугольник <span class='text-light-grey'>(7)</span>
              </label>
              <img src='/img/icons/checked-icon.svg' alt='check arrow' class='absolute w-5 h-5 2xl:w-7 2xl:h-7 hidden peer-checked:block pointer-events-none'>
            </li>
            <li class='contact__form-check flex items-center gap-x-3 border-t border-b py-2'>
              <input id='shape-large' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:hover-bg'>
        ...
        <div class='catalog__form-style'>
          ...
          <ul>
            <li class='contact__form-check flex items-center gap-x-3 border-t border-b py-2'>
              <input id='style-1' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:hover-bg'>
              <label for='style-1' class='text-14-300 !leading-[125%]'>Растительный сюжет <span class='text-light-grey'>(7)</span>
              </label>
              <img src='/img/icons/checked-icon.svg' alt='check arrow' class='absolute w-5 h-5 2xl:w-7 2xl:h-7 hidden peer-checked:block pointer-events-none'>
            </li>
            <li class='contact__form-check flex items-center gap-x-3 border-t border-b py-2'>
              <input id='style-2' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:hover-bg'>
              <label for='style-2' class='text-14-300 !leading-[125%]'>Геометрическое панно <span class='text-light-grey'>(7)</span>
              </label>
              <img src='/img/icons/checked-icon.svg' alt='check arrow' class='absolute w-5 h-5 2xl:w-7 2xl:h-7 hidden peer-checked:block pointer-events-none'>
            </li>
            <li class='contact__form-check flex items-center gap-x-3 border-t border-b py-2'>
              <input id='style-3' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:hover-bg'>
              <label for='style-3' class='text-14-300 !leading-[125%]'>Арт-деко <span class='text-light-grey'>(7)</span>
              </label>
              <img src='/img/icons/checked-icon.svg' alt='check arrow' class='absolute w-5 h-5 2xl:w-7 2xl:h-7 hidden peer-checked:block pointer-events-none'>
            </li>
            <li class='contact__form-check flex items-center gap-x-3 border-t border-b py-2'>
              <input id='style-4' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:hover-bg'>
              <label for='style-4' class='text-14-300 !leading-[125%]'>Советский сюрреализм <span class='text-light-grey'>(7)</span>
              </label>
              <img src='/img/icons/checked-icon.svg' alt='check arrow' class='absolute w-5 h-5 2xl:w-7 2xl:h-7 hidden peer-checked:block pointer-events-none'>
            </li>
            <li class='contact__form-check flex items-center gap-x-3 border-t border-b py-2'>
              <input id='style-5' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:hover-bg'>
         ...
         <button class='contact__form-button w-full px-4 2xl:px-10 py-[15px] 2xl:py-[22px] text-light text-button-primary uppercase bg-primary sm:px-6 hover:hover-bg'>
            Применить
          </button>
    ...
    <div class='catalog__list flex flex-col w-full xl:w-auto xl:flex-[5] sm:flex-row sm:flex-wrap gap-x-5 gap-y-10 md:gap-y-[60px] xl:gap-x-[45px] xl:gap-y-[62px] 2xl:gap-x-[48px] 2xl:gap-y-[84px] [&>div]:flex-1 [&>div]:basis-[32%] [&>div]:xl:basis-[30%]'>
      ...
      <div class='catalog__list-item flex  flex-col gap-y-4'>
        ...
        <button class='shop__button flex justify-center items-center px-6 py-[12px] 2xl:py-[18px] border border-primary lg:order-1 hover:hover-text hover:hover-border'>
      ...
      <button class='contact__form-button w-full px-4 lg:w-fit lg:m-auto 2xl:px-10 py-[15px] 2xl:py-[22px] text-light text-button-primary uppercase bg-primary sm:px-6 hover:hover-bg'>
            показать ещё
      </button>
