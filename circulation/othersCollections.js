export const othersCollections = document.createElement('section')
othersCollections.classList.add('others-collections')
 ...
 <div class='catalog__others mx-5 pt-10 xl:pt-20 md:mx-10 xl:mx-20 2xl:mx-[120px]'>
  ...
  <div class='principles__title text-26-300 text-left pb-3 '>
    <div class='m-auto md:px-0'>
      <h2 class='uppercase'>Рекомендуем посмотреть другие коллекции</h2>
    </div>
  </div>
  
  <div class='catalog__subtitle'>
    <h3 class='text-24-300'>Люксовая коллекция</h3>
  </div>
</div>
