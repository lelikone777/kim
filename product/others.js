export const others = document.createElement('section')
others.classList.add('others', 'section')

others.innerHTML = `
 


  <div class='catalog__subtitle px-5 md:px-10 xl:px-20 2xl:px-[120px] max-w-screen-2xl 2xl:m-auto'>
    <h3 class='text-24-300 '>Ознакомьтесь с другими барельефами из тиражной коллекции</h3>
  </div>
