    ...
    <div class='flex flex-col gap-y-5 info p-5 md:p-10 xl:p-20 max-w-[728px]'>
      ...
      <form class='price__form flex flex-col gap-y-5 md:gap-y-5'>
        <div class='price__form-inputs gap-y-3 md:gap-x-5 grid grid-cols-1 md:grid-cols-2'>
          <input type='text' placeholder='имя' class='price__form-name col-span-1 px-4 py-[15px] w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] placeholder:tracking-[2.1px] placeholder:uppercase max-h-12 hover:hover-input'/>
          <input type='text' placeholder='телефон' class='price__form-phone col-span-1 px-4 py-[15px] w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] placeholder:tracking-[2.1px] placeholder:uppercase max-h-12 hover:hover-input'/>
          <textarea type='text' placeholder='Ваши пожелания' rows='4' class='price__form-phone col-span-1 md:col-span-2 px-4 py-[15px] w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] placeholder:tracking-[2.1px] placeholder:uppercase hover:hover-input'></textarea>
        </div>
        ...
        <div class='price__bottom flex flex-col gap-y-5 md:flex-row md:justify-between gap-x-5'>
            <div class='price__form-check flex items-center gap-x-3'>
              ...
              <label for='primary-checkbox' class='text-light-grey text-[10px] 2xl:text-[10px] leading-[140%] tracking-[0.3px] 2xl:tracking-[0.42px] sm:max-w-[330px] 2xl:max-w-[450px] checked:hover:hover-bg'
            ...
            <button class='price__form-button w-full px-4 2xl:px-10 py-[15px] 2xl:py-[22px] text-light text-button-primary uppercase bg-primary md:px-6 md:w-fit hover:hover-bg'>
              Отправить
            </button>
        </div>
      </form>
