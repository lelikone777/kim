...
<div class='overlay grid place-content-center h-screen w-screen bg-lighter-grey'>
  <div class='modal__author-copy-wrapper bg-light flex w-fit h-fit m-auto'>
  
    <div class='image hidden xl:block'>
      <img src='/img/images/modalAuthorCopy.jpg' alt='modal-info'>
    </div>

    <div class='flex flex-col gap-y-5 info p-5 md:p-10 xl:p-20 2xl:p-[120px] max-w-[728px]'>
      <div class='info-top flex flex-col gap-y-2'>
        <div class='modal__author-copy-title text-26-300'>Заказ авторской копии барельефа «BUG»</div>
        <p class='text-16-400'>
      ...
      <form class='price__form flex flex-col gap-y-5 md:gap-y-5'>
        <div class='price__form-inputs gap-y-3 md:gap-x-5 grid grid-cols-1 md:grid-cols-2'>
          <input type='text' placeholder='имя' class='price__form-name col-span-1 px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase'/>
          <input type='text' placeholder='телефон' class='price__form-phone col-span-1 px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase'/>
          <textarea type='text' placeholder='Ваши пожелания' rows='4' class='price__form-phone col-span-1 md:col-span-2 px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase'></textarea>
        </div>
