...
review.innerHTML = `
  <div class='wrapper flex flex-col mr-auto px-5 md:px-10 xl:px-20 2xl:px-[120px] max-w-screen-2xl gap-y-3 md:gap-x-5 xl:gap-x-10 m-auto'>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="28" viewBox="0 0 32 28" fill="none" class='absolute left-[-16px] top-[-16px] 2xl:w-[48px] h-[42px] w-max'>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="28" viewBox="0 0 32 28" fill="none" class='absolute right-[-16px] bottom-[-16px] 2xl:w-[48px] h-[42px] w-max'>
