export const whyProject = document.createElement('section')
whyProject.classList.add('why-project', 'section')

whyProject.innerHTML = `
<div class='wrapper px-5 md:px-10 xl:px-20 2xl:px-[120px] max-w-screen-2xl m-auto'>
    <div class='principles__title text-26-300 text-left pb-3 md:pb-5 xl:pb-10'>
      <div class='m-auto md:px-0'>
        <h2 class='uppercase'>Почему стоит заказать эксклюзивный проект</h2>
      </div>
    </div>

  
    <div class='info flex justify-between gap-x-5'>
      <div class='left flex flex-1 flex-col gap-y-5 max-w-[324px] md:max-w-[456px] xl:max-w-[788px]'>
        <div class=''>
      ...
      <div class='right flex flex-1 flex-col gap-y-5 max-w-[324px] md:max-w-[456px] xl:max-w-[788px]'>
        <div class=''>
