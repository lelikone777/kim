    ...
    <div class='contact__info flex flex-col gap-y-5 pt-2 md:gap-y-10 2xl:gap-y-16 xl:flex-1 xl:pl-20'>
      ...
      <form class='contact__form flex flex-col gap-y-3 md:gap-y-5'>
        <div class='contact__form-inputs flex md:flex-wrap flex-col gap-y-3 md:flex-row md:gap-x-5 md:grid md:grid-cols-2'>
          <input type='text' placeholder='имя' class='contact__form-name flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase md:basis-44 md:col-span-1 hover:hover-input'>
          ...
          <div class='relative md:col-span-2'>
            <input type='text' placeholder='прикрепите файл' class='contact__form-phone flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase hover:hover-input'>
        ...
        <div class='contact__bottom flex flex-col gap-y-3 md:flex-row md:justify-between md:gap-x-5'>
          <div class='contact__form-check flex items-center gap-x-3 md:w-full'>
            <input checked id='primary-checkbox' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:hover:bg-primary'>
          ...
          <div class=' flex '>
            <button class='contact__form-button px-2 md:w-full 2xl:px-10 py-[15px] 2xl:py-[22px] text-light text-[14px] 2xl:text-[16px] tracking-[2.1px] 2xl:tracking-[2.4px] uppercase bg-primary sm:px-6 hover:hover-bg'>
            Отправить
          </button>
          </div>
        </div>
      ...
      <div class=''>
        ...
        <button
          class='price__whatsapp-button flex flex-center xl:justify-start w-full lg:w-fit border border-primary px-6 py-[16px] 2xl:px-10 2xl:py-[22px] text-primary text-[12px] 2xl:text-[16px] font-bold leading-normal tracking-[0.6px] 2xl:tracking-[2.4px] uppercase mt-5 hover:hover-text hover:hover-border'>
