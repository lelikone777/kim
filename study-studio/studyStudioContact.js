export const studyStudioContact = document.createElement('section')
studyStudioContact.classList.add('study-studio__contact', 'section')

studyStudioContact.innerHTML = `
