export const slider1 = document.createElement('section')
slider1.classList.add('slider1', 'section')
...
slider1.innerHTML = `
  ...
  <div class='projects__title flex flex-col gap-y-3 px-5 md:px-10 xl:px-20 2xl:px-[120px] items-start text-left w-full'>
    <h2 class='inline-block text-24-300 uppercase'>Самый простой способ начать дружбу это посетить наши мероприятия</h2>
  </div>
