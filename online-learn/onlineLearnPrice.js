export const onlineLearnPrice = document.createElement('section')
onlineLearnPrice.classList.add('onlineLearnPrice', 'section')

onlineLearnPrice.innerHTML = `
<div class='price__wrapper relative max-w-screen-2xl m-auto'>
  ...
  <div class='price__box relative border border-semi-grey mx-5 md:mx-10 xl:mx-20 px-5 sm:px-10 md:px-20 py-5 sm:py-10 md:py-20 xl:flex xl:gap-x-10 2xl:gap-x-[120px]' >
    <div class='flop h-[55vw] md:h-[46.878vw] xl:h-full relative top-3 md:top-5 xl:flex-1'></div>

    <div class='price__info flex flex-col pt-2 xl:flex-1 gap-y-5'>
    
      <div class='flex flex-col gap-y-5 pt-2 md:gap-y-10 2xl:gap-y-16 xl:flex-1'>
            ...
            <div class='price__text flex flex-col gap-y-3 items-start text-left'>
             <p class='inline-block text-[26px] 2xl:text-[40px] leading-[140%] tracking-[0.5px] 2xl:tracking-[0.8px] uppercase'>
                Не знаете какой мастер класс выбрать? 
                  <span
            ...
            <form class='price__form flex flex-col gap-y-3 md:gap-y-5'>
              <div class='price__form-inputs flex flex-col gap-y-3 sm:flex-row sm:gap-x-5'>
                ...
                <div class='flex relative flex-1 '>
                  ...
                  <label for='name' class='absolute hidden'>Имя</label>
                  <input type='text' id='name' placeholder='имя' class='price__form-name flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase hover:hover-input text-14-400 hover:hover-input'/>
                </div>
                <div class='flex relative flex-1 '>
                  <label for='phone' class='absolute hidden'>телефон</label>
                  <input type='text' id='phone' placeholder='телефон' class='price__form-phone flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase hover:hover-input hover:hover-input'/>
                </div>
              </div>
              ...
              <div class='price__bottom flex flex-col gap-y-3 sm:flex-row sm:justify-between sm:gap-x-5'>
                <div class='price__form-check flex items-center gap-x-3'>
                  <input checked id='primary-checkbox' type='checkbox' value='' class='relative peer shrink-0 appearance-none w-5 h-5 2xl:w-7 2xl:h-7 border border-primary rounded-none bg-light checked:bg-primary checked:hover:hover-bg'/>
      ...
      <button
        class='price__whatsapp-button flex flex-center xl:justify-start w-full lg:w-fit border border-primary px-6 py-[16px] 2xl:px-10 2xl:py-[22p] text-primary text-[12px] 2xl:text-[16px] font-bold leading-normal tracking-[0.6px] 2xl:tracking-[2.4px] uppercase hover:hover-text hover:hover-border hover:hover-text hover:hover-border'>
        <img src='/img/icons/whatsapp-logo.svg' alt='whatsapp logo' class='w-[20px] h-[20px]'/>
        <span class='ml-2 hover:hover-text hover:hover-text'>или напишите в whatsapp</span>
      </button>
    </div>
  </div>
</div>
