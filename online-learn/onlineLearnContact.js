export const onlineLearnContact = document.createElement('section')
onlineLearnContact.classList.add('study-learn__contact', 'section')

onlineLearnContact.innerHTML = `
