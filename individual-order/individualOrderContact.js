export const individualOrderContact = document.createElement('section')
individualOrderContact.classList.add('individual-order__contact', 'section')

individualOrderContact.innerHTML = `
  ...
  <div
    ...
    <div
      ...
      <button
        class='price__whatsapp-button flex flex-center xl:justify-start w-full lg:w-fit border border-primary px-6 py-[14px] 2xl:px-10 2xl:py-[22p] text-primary text-[12px] 2xl:text-[16px] font-bold leading-normal tracking-[0.6px] 2xl:tracking-[2.4px] uppercase hover:hover-text hover:hover-border'>
