export const teamHeader = document.createElement('header')
teamHeader.classList.add('team__header')

teamHeader.innerHTML = `
  
   <div class='header relative text-light bg-hero-team-2xl bg-[length:auto_100%] bg-no-repeat bg-top min-h-screen md:bg-cover'>
