export const individualLearningTenth = document.createElement('section')
individualLearningTenth.classList.add('individual-learning__tenth', 'section')

individualLearningTenth.innerHTML = `
  <div class='price__wrapper relative max-w-screen-2xl m-auto'>
    <div class='price__image absolute left-0 right-0 xl:right-auto z-10 top-3 md:top-5 2xl:top-1/2 2xl:translate-y-[-50%] h-[55vw] md:h-[46.878vw] xl:h-[619px] xl:w-[662px] xl:top-1/2 xl:translate-y-[-50%] 2xl:h-[741px] 2xl:w-[936px] overflow-hidden xl:max-w-none xl:w-[46vw]'>

      <img
        src='/img/images/individual-learning/contact-md.jpg'
        alt='contact image'
        class='relative xl:bottom-auto xl:max-w-none xl:w-[118%] xl:left-[-10%] 2xl:w-full 2xl:left-auto xl:hidden'
      />
      
      <img
        src='/img/images/individual-learning/contact-xl.jpg'
        alt='contact image'
        class='relative xl:bottom-auto xl:max-w-none xl:w-[118%] xl:left-[-10%] 2xl:w-full 2xl:left-auto'
      />
      ...
      <div class='price__info flex flex-col gap-y-5 pt-2 md:gap-y-10 2xl:gap-y-16 xl:flex-1'>
          ...
          <p class='inline-block text-[26px] 2xl:text-[40px] leading-[140%] tracking-[0.5px] 2xl:tracking-[0.8px] uppercase'>
            Хочу индивидуальное обучение
              <span
                ...
                Перезвоним вам <br> в течении 10 минут
              </span>
          </p>
        ...
        <form class='price__form flex flex-col gap-y-3 md:gap-y-5'>
          <div class='price__form-inputs flex flex-col gap-y-3 sm:flex-row sm:gap-x-5'>
            <input type='text' placeholder='имя' class='price__form-name flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase hover:hover-border'/>
            <input type='text' placeholder='телефон' class='price__form-phone flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase hover:hover-border'/>
          </div>
        ...
        <button
          class='price__whatsapp-button flex flex-center xl:justify-start w-full lg:w-fit border border-primary px-6 py-[14px] 2xl:px-10 2xl:py-[22p] text-primary text-[12px] 2xl:text-[16px] font-bold leading-normal tracking-[0.6px] 2xl:tracking-[2.4px] uppercase hover:hover-border hover:hover-text'>
