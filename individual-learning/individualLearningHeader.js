export const individualLearningHeader = document.createElement('header')
individualLearningHeader.classList.add('individual-learning__header')

individualLearningHeader.innerHTML = `
