export const individualLearningSixth = document.createElement('section')
individualLearningSixth.classList.add('individual-learning__sixth', 'section')

individualLearningSixth.innerHTML = `
 ...
 <div class='wrapper px-5 md:px-10 xl:px-20 2xl:px-[120px] max-w-screen-2xl m-auto'>
  ...
  <div class='principles__title text-26-300 text-left pb-5 xl:pb-10'>
    <div class='m-auto md:px-0'>
      <h2 class='uppercase'>Вы поймёте:</h2>
    </div>
  </div>
  ...
  <div class='flex flex-col items-start xl:flex-row'>
      ...
      <div class='xl:flex xl:flex-1'>
        <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
          ...
          <div class='text-14-20-300 flex items-center xl:pr-10'>
            На сколько важен вербальный язык в современном искусстве
          </div>
      ...
      <div class='xl:flex xl:flex-1'>
        <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
          ...
          <div class='text-14-20-300 flex items-center xl:pr-10'>
            Как важно использовать разные медиумы и как их можно компилировать между собой
          </div>
      ...
      <div class='xl:flex xl:flex-1 '>
        <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
          ...
          <div class='text-14-20-300 flex items-center xl:pr-10'>То как через символы и сигналы считываются смыслы</div>
