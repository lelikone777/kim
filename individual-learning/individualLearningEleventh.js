export const individualLearningEleventh = document.createElement('section')
individualLearningEleventh.classList.add(
  'individual-learning__eleventh',
  'section',
)

individualLearningEleventh.innerHTML = `
