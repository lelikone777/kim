export const mkOnlineWhom = document.createElement('section')
mkOnlineWhom.classList.add('mk-online__whom', 'section')

mkOnlineWhom.innerHTML = `
...
<div class='principles__wrapper flex flex-col gap-y-5 pl-0 pr-0 pb-5 md:pb-10 xl:p-20 w-full m-auto px-5 md:px-10 xl:px-20 2xl:px-[120px] max-w-screen-2xl !py-0'>
    ...
    <div class='principles__list flex flex-col lg:flex-row gap-y-5 lg:gap-y-10 lg:gap-x-[42px] xl:gap-x-[48px] pr-5 md:pr-0 lg:pr-0'>
      <div class='principles__card flex lg:flex-col flex-1 gap-x-5 md:gap-x-10 pr-3 lg:pr-0 relative'>
        ...
        <div class='principles__card-image'>
          <div class='sm:hidden w-[80px] overflow-hidden'>
            <img src='/img/images/mk-online/whom-sm-1.jpg' />
          </div>
          <div class='hidden sm:flex w-[197px] lg:w-full'>
            <img src='/img/images/mk-online/whom-2xl-1.jpg' alt='principles image' />
          </div>
        </div>
        <div class='principles__card-info flex flex-col justify-center gap-y-3 py-3 md:py-7 lg:pb-12'>
          <div class='principles__card-text'>
            <p class='text-14-300 text-deep-grey max-w-[96%]'>
              Тем, кто хочет получить углубленные знания о принципах построения плоскостей и их гладкой отделке
          </div>
        </div>
      </div>
      ...
      <div class='principles__card flex lg:flex-col flex-1 gap-x-5 md:gap-x-10 pr-3 lg:pr-0 relative'>
        ...
        <div class='principles__card-image'>
          <div class='sm:hidden w-[80px] overflow-hidden'>
            <img src='/img/images/mk-online/whom-sm-2.jpg' alt='principles image' />
          </div>
          <div class='hidden sm:flex w-[197px] lg:w-full'>
            <img src='/img/images/mk-online/whom-2xl-2.jpg' alt='principles image' />
          </div>
        </div>
        <div class='principles__card-info flex flex-col justify-center gap-y-3 py-3 md:py-7'>
          <div class='principles__card-text'>
            <p class='text-14-300 text-deep-grey max-w-[96%]'>
              Тем, кому интересно создание иллюзии движения
            </p>
          </div>
        </div>
      </div>
      ...
      <div class='principles__card flex lg:flex-col flex-1 gap-x-5 md:gap-x-10 pr-3 lg:pr-0 relative'>
        ...
        <div class='principles__card-image'>
          <div class='sm:hidden w-[80px] overflow-hidden'>
            <img src='/img/images/mk-online/whom-sm-3.jpg' alt='principles image' />
          </div>
          <div class='hidden sm:flex w-[197px] lg:w-full'>
            <img src='/img/images/mk-online/whom-2xl-3.jpg' alt='principles image' />
          </div>
        </div>
        <div class='principles__card-info flex flex-col justify-center gap-y-3 py-3 md:py-7'>
          <div class='principles__card-text'>
            <p class='text-14-300 text-deep-grey max-w-[96%]'>
              Всем, кому хотелось бы быстро создать эффектный арт-объект и поработать с динамикой в изображении
            </p>
          </div>
        </div>
      </div>
