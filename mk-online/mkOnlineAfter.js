export const mkOnlineAfter = document.createElement('section')
mkOnlineAfter.classList.add('mk-studio__after', 'section')

mkOnlineAfter.innerHTML = `
        ...
        <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
          <div class='flex flex-col xl:flex-row'>
            ...
            <div class=' flex justify-center items-center w-12 h-12 xl:w-16 xl:h-16 border border-semi-grey shrink-0 relative'>
              ...
              <svg class='absolute bottom-[-2px] left-1/2 translate-x-[-50%] w-1 h-1 xl:w-2 xl:h-2 z-20 xl:bottom-auto xl:left-auto xl:translate-x-0 xl:top-1/2 xl:right-[-4px] xl:translate-y-[-50%]' xmlns="http://www.w3.org/2000/svg" width="8" height="7" viewBox="0 0 8 7" fill="none">
