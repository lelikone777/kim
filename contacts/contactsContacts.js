export const contactsContacts = document.createElement('section')
contactsContacts.classList.add('contacts__contacts', 'section')

contactsContacts.innerHTML = `
  
  <div class='price__wrapper relative max-w-screen-2xl m-auto'>
  <div class='price__image absolute left-0 right-0 xl:right-auto z-10 top-3 md:top-5 2xl:top-1/2 2xl:translate-y-[-50%] h-[55vw] md:h-[46.878vw] xl:h-[619px] xl:w-[662px] xl:top-1/2 xl:translate-y-[-50%] 2xl:h-[741px] 2xl:w-[936px] overflow-hidden'>
    <img
 ...
 <form class='price__form flex flex-col gap-y-3 md:gap-y-5'>
        <div class='price__form-inputs grid grid-cols-2 grid-flow-row-dense gap-y-3 md:flex-row md:gap-x-5'>
          <input type='text' placeholder='имя' class='price__form-name flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase col-span-2 md:col-span-1'/>
          <input type='text' placeholder='телефон' class='price__form-phone flex px-4 py-[15px] 2xl:py-[22px] 2xl:px-5 w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] 2xl:placeholder:text-[16px] placeholder:tracking-[2.1px] placeholder:uppercase col-span-2 md:col-span-1'/>
          <textarea type='text' placeholder='Ваш вопрос' rows='4' class='price__form-phone md:col-span-2 px-4 py-[15px] w-full border border-secondary border-l-primary placeholder:text-light-grey placeholder:text-[14px] placeholder:tracking-[2.1px] placeholder:uppercase col-span-2'></textarea>
        </div>
      ...
      <button class='price__whatsapp-button flex flex-center xl:justify-start w-full lg:w-fit border border-primary px-6 py-[14px] 2xl:px-10 2xl:py-[22p] text-primary text-[12px] 2xl:text-[16px] font-bold leading-normal tracking-[0.6px] 2xl:tracking-[2.4px] uppercase'>
