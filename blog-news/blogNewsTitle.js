export const blogNewsTitle = document.createElement('section')
blogNewsTitle.classList.add('blog-news__title')

blogNewsTitle.innerHTML = `
...
<div class="academy-profile__wrapper flex flex-col gap-y-1 my-5 ml-auto mr-auto px-5 md:px-10 xl:px-20 2xl:px-[120px] max-w-screen-2xl">
  ...
  <div class="academy-profile__title flex mb-3">
    <h2 class=" text-32-300 uppercase">Блог/новости</h2>
  </div>
