...
academyWhy.classList.add('newHobby-why', 'section')
      ...
      <div class='xl:flex xl:flex-1'>
        <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
          ...
          <div class='text-14-20-300 justify-center items-start xl:pr-10 xl:max-w-[374px] 2xl:max-w-[528px] flex flex-col gap-y-1'>
            <p class='text-14-20-300'>Оплачиваете МК</p>
          </div>
      ...
      <!--      2-->
        <div class='xl:flex xl:flex-1'>
          <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
            ...
            <div class='text-14-20-300 justify-center items-start xl:pr-10 xl:max-w-[374px] 2xl:max-w-[528px] flex flex-col gap-y-1'>
              <p class='text-14-20-300'>Получаете доступ в личный кабинет Геткурcа</p>
            </div>
      ...
      <!--      3-->
        <div class='xl:flex xl:flex-1'>
          <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
            ...
            <div class='text-14-20-300 justify-center items-start xl:pr-10 xl:max-w-[374px] 2xl:max-w-[528px] flex flex-col gap-y-1'>
              <p class='text-14-20-300'>Изучаете вводный урок, где расписаны все необходимые материалы для работы. Приобретаете их.</p>
            </div>
      ...
      <!--        4-->
        <div class='xl:flex xl:basis-[31.733333%] 2xl:basis-[31.333333%]'>
          <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
            ...
            <div class='text-14-20-300 justify-center items-start xl:pr-10 xl:max-w-[374px] 2xl:max-w-[528px] flex flex-col gap-y-1'>
              <p class='text-14-20-300'>Поэтапно проходите темы одну за одной до конечного результата.</p>
            </div>
  ...
  <!--          5-->
    <div class='xl:flex xl:basis-[31.733333%] 2xl:basis-[31.333333%]'>
      <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
        ...
        <div class='text-14-20-300 justify-center items-start xl:pr-10 xl:max-w-[374px] 2xl:max-w-[528px] flex flex-col gap-y-1'>
          <p class='text-14-20-300'>При желании, вы можете воспользоваться услугой сопровождения скульптора</p>
        </div>
