export const mkStudioAfterTraining = document.createElement('section')
mkStudioAfterTraining.classList.add('mk-studio__after-training', 'section')

mkStudioAfterTraining.innerHTML = `
 ...
 <div class='wrapper px-5 md:px-10 xl:px-20 2xl:px-[120px] max-w-screen-2xl m-auto'>
  ...
  <div class='principles__title text-26-300 text-left pb-5 xl:pb-10'>
    <div class='m-auto md:px-0'>
      <h2 class='uppercase'>Что вас ждёт после обучения</h2>
    </div>
  </div>
  ...
  <div class='flex flex-col items-start xl:flex-row'>
      ...
      <div class='xl:flex xl:flex-1'>
        <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
          ...
          <div class='text-14-20-300 flex items-center xl:pr-10'>
            Научитесь техническим и художественным принципам работы над барельефами, создадите собственный арт-объект
          </div>
      ...
      <div class='xl:flex xl:flex-1'>
        <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
          ...
          <div class='text-14-20-300 flex items-center xl:pr-10'>
            Станете частью прекрасного творческого сообщества
          </div>
        ...
        <div class='flex justify-between gap-x-4 xl:flex-col gap-y-4 flex-1'>
          <div class='flex flex-col xl:flex-row'>
            ...
            <div class=' flex justify-center items-center w-12 h-12 xl:w-16 xl:h-16 border border-semi-grey shrink-0 relative'>
              ...
              <svg class='absolute bottom-[-2px] left-1/2 translate-x-[-50%] w-1 h-1 xl:w-2 xl:h-2 z-20 xl:bottom-auto xl:left-auto xl:translate-x-0 xl:top-1/2 xl:right-[-2px] xl:translate-y-[-50%]' xmlns="http://www.w3.org/2000/svg" width="8" height="7" viewBox="0 0 8 7" fill="none">
          ...
          <div class='text-14-20-300 flex items-center xl:pr-10'>Получите скидку на другие мастер-классы, чтобы продолжать углублять свои знания</div>
