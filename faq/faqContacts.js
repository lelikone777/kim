export const faqContacts = document.createElement('section')
faqContacts.classList.add('faq__contacts', 'section')

faqContacts.innerHTML = `
...
<div class='price__wrapper relative max-w-screen-2xl m-auto'>
  ...
  <div class='price__box relative border border-semi-grey mx-5 md:mx-10 xl:mx-20 px-5 sm:px-10 md:px-20 py-5 sm:py-10 md:py-20 xl:flex 2xl:gap-x-20 2xl:mx-[120px]'>
    ...
    <div class='price__info flex flex-col gap-y-5 pt-2 md:gap-y-10 2xl:gap-y-16 xl:flex-1'>
      ...
      <button class='price__whatsapp-button flex flex-center xl:justify-start w-full lg:w-fit border border-primary px-6 py-[14px] 2xl:px-10 2xl:py-[22p] text-primary text-[12px] 2xl:text-[16px] font-bold leading-normal tracking-[0.6px] 2xl:tracking-[2.4px] uppercase hover:hover-text hover:hover-border'>
